...
define('RECAPTCHA_SITE_KEY', '6LdyN_ErAAAAAGE6p0uIPgeY5Z6TZ6OVhCJt0Jis'); // Clé publique
define('RECAPTCHA_SECRET_KEY', '6LdyN_ErAAAAAHvhEMuMeboxqaXENzMnJ1s-KNAT'); // Clé secrète
